...
class RedBlackTree
{
    ...
    public void Insert(int newValue)
    {
        ...
        FixRBT_AfterInsert(newNode);
    }

    // Method to restore Red-Black properties after insertion
    private void FixRBT_AfterInsert(Node node)
    {
        Node parent = null;
    ...
    private void DeleteNode(Node nodeToDelete)
    {
        ...
        if (!originalColor && child != null)
            FixRBT_AfterDelete(child);  // Call the fix-up method to maintain Red-Black properties
    }
    ...
    private void FixRBT_AfterDelete(Node node)
    {
        ...
        while (node != root && !node.IsRed)
        {
            ...
            /*
            Scenario: The sibling of the double black node is red.
            Action:
            1.When you delete the node, it becomes double black.
            2.Perform a rotation to move the red sibling to the parent's position.
            3.Swap the colors of the sibling and the parent(color the sibling black and the parent red).
            4.The double black situation still exists, but now the sibling of the double black node is black,
            allowing you to continue with the appropriate steps for Case 2. */
